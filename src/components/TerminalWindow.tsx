    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="relative w-8 h-8">
          ...
          {bootPhase === 'almost' && (
            <p className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-xs text-muted-foreground whitespace-nowrap font-mono animate-[blink_0.5s_step-end_infinite]">loading ...</p>
          )}
        </div>
      </div>
    );
